export class ObjectUtils {
   ...
   */
  public static mergeDeep<T extends Record<string, any>>(target: Partial<T>, sources: Partial<T>[], extra?: {explicitMerge?: string[]}): Partial<T> {
    if (!sources.length) {
      return target;
    }
  ...
  public static mergeDefaults<T extends Record<string, any>>(source: Partial<T>, defaults: T, extra?: {explicitMerge?: string[]}): T {
   ...
   * @param source
   */
  public static explicitFlatMerge<T extends Record<string, any>>(initialObject: Partial<T>, source: Partial<T>): any {
